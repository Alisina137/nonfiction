...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    if (params.get("start") === "1") router.push("/dashboard");
  }, [router]);
      ...
      <header className="sticky top-0 z-20 border-b border-white/10 bg-studio-900/80 backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="flex items-center gap-2">
            ...
            <button className="btn-primary" onClick={() => router.push("/dashboard")}>Enter Studio</button>
          </nav>
        </div>
      </header>
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-8 px-6 pb-16 pt-12 md:grid-cols-[1.2fr_0.8fr] md:pt-20">
        <div>
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <button className="btn-primary" onClick={() => { setStarting(true); router.push("/dashboard"); }}>
