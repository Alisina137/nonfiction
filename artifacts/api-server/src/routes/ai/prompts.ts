...
// ─── KDP Final Positioning prompt (post-Analysis optimisation) ────────────────

export function kdpFinalPositioningPrompt({
  ...
  return `You are an elite Amazon KDP publishing strategist, book positioning expert, and nonfiction market analyst.

Your task is to create the FINAL optimized book positioning for publication.
...
Analyze ALL information from both Research and Analysis.

Do NOT simply rewrite the existing title.

Your goal is to create the strongest possible Amazon KDP positioning.

Optimize for:

- Reader appeal
- Click-through rate
- Amazon conversion potential
...
Choose whichever title structure is strongest:
...
- Sound like a real bestselling nonfiction book
...
- Support the title without repeating it
...
- Clearly define who the book serves
- Clearly define what problem it solves
- Clearly define the outcome
- Explain what frameworks, systems, strategies, or methods will be taught
- Be detailed enough to guide outline generation and book writing
...

{
  ...
  "topicOptions": [
    { "topic": "", "style": "Beginner-Friendly" },
    { "topic": "", "style": "Practical & Action-Oriented" },
    { "topic": "", "style": "Comprehensive Authority" }
  ]
}`;
}
